...
function getEmailValidationKey() {
  return MESSAGES.INVALID_EMAIL;
}

function getPhoneValidationKey() {
  return MESSAGES.INVALID_PHONE;
}

class EmployeeForm extends r {
      ...
      <div class="form-container">
        <form @submit=${this._handleSubmit}>
          <div class="form-group">
            ...
            />
            ${this.errors[EmployeeFields.FIRST_NAME] ? x`<div class="form-error">${this.errors[EmployeeFields.FIRST_NAME]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            <input 
              ...
              @input=${this._handleInputChange}
            />
            ${this.errors[EmployeeFields.LAST_NAME] ? x`<div class="form-error">${this.errors[EmployeeFields.LAST_NAME]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            <input 
              ...
              @input=${this._handleInputChange}
            />
            ${this.errors[EmployeeFields.DATE_OF_EMPLOYMENT] ? x`<div class="form-error">${this.errors[EmployeeFields.DATE_OF_EMPLOYMENT]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            <input 
              ...
              @input=${this._handleInputChange}
            />
            ${this.errors[EmployeeFields.DATE_OF_BIRTH] ? x`<div class="form-error">${this.errors[EmployeeFields.DATE_OF_BIRTH]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            <input 
              ...
              @input=${this._handleInputChange}
            />
            ${this.errors[EmployeeFields.PHONE_NUMBER] ? x`<div class="form-error">${this.errors[EmployeeFields.PHONE_NUMBER]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            <input 
              ...
              @input=${this._handleInputChange}
            />
            ${this.errors[EmployeeFields.EMAIL] ? x`<div class="form-error">${this.errors[EmployeeFields.EMAIL]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            ${this.errors[EmployeeFields.DEPARTMENT] ? x`<div class="form-error">${this.errors[EmployeeFields.DEPARTMENT]}</div>` : ''}
          </div>
          ...
          <div class="form-group">
            ...
            ${this.errors[EmployeeFields.POSITION] ? x`<div class="form-error">${this.errors[EmployeeFields.POSITION]}</div>` : ''}
          </div>
